...
const Home = () => {
  ...
  return (
    <View style={{ backgroundColor: '#36393F', height: '100%', elevation: 2 }}>
      <FlatList
        ...
        renderItem={({ item, index, separators }) => (
          <View
            ...
            <View
              style={{
                backgroundColor:
                  itemList.find(o => o.name == item.title)?.color ?? '#9bf6ff',
                borderRadius: 10,
                width: 35,
                height: 35,
              ...
              <MaterialCommunityIcon
                name={itemList.find(o => o.name == item.title)?.icon ?? 'atom'}
                color="#202225"
          ...
          <Pressable
            ...
            <Pressable
              style={{
                ...
                alignItems: 'center',
                margin: 10,
                borderWidth: items[unitPicker.index]?.unit == unit.g ? 1.25 : 0,
                borderColor: '#DCDDDE',
              }}
              onPress={() => {
                dispatch(changeUnit({ index: unitPicker.index, unit: unit.g }));
                setUnitPicker({ ...unitPicker, visible: !unitPicker.visible });
      ...
      <View style={{ position: 'relative', flexDirection: 'column', flex: 1 }}>
        <Pressable
          ...
          onPress={() => setNewItem({ ...newItem, visible: !newItem.visible })}
          onLongPress={() => {
            dispatch(clearAllItems());
          }}>
          <AntDesignIcon name="plus" size={30} color="#caffbf"></AntDesignIcon>
        </Pressable>
      </View>
